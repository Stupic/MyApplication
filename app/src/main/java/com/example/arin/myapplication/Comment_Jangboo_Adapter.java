 ...
 */
public class Comment_Jangboo_Adapter  extends BaseAdapter {

    Context context;
    private ArrayList<Comment_Jangboo_Item> arr;
    ...
    public Comment_Jangboo_Adapter(Context context, ArrayList<Comment_Jangboo_Item> list_itemArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewholder.nickname_textView.setText(arr.get(position).getName());
        viewholder.content_textView.setText(arr.get(position).getCheck());
